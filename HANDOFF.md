...
Current release: **1.4.0** (2026-09-26; History, Like, Control Center-style menu bar tiles, search paging and suggestions, background CPU pass). 1.0.0 was the first stable build. Betas before it: 0.1.0-beta.1 … 0.2.0-beta.5.
